//Dependencies
const databaseMethods = require("./queries");
...
async function viewEmployee() {
  ...
  const employee = await methods.viewEmployees();
...
async function viewDepartments() {
  ...
  const department = await methods.viewDepartments();
...
async function departmentMenu() {
  depArray = [];
  const methods = await new databaseMethods();
  let departments = await methods.viewDepartments();
...
async function EmployeeMenu() {
  let empArray = [];
  const methods = new databaseMethods();
  let employees = await methods.viewEmployees();
